...
(function(){
	...
	Chart.defaults = {
		global: {
			...
			// String - Scale label bootstrap.fonts declaration for the scale label
			scaleFontFamily: "'Helvetica Neue', 'Helvetica', 'Arial', sans-serif",

			// Number - Scale label bootstrap.fonts size in pixels
			scaleFontSize: 12,

			// String - Scale label bootstrap.fonts weight style
			scaleFontStyle: "normal",

			// String - Scale label bootstrap.fonts colour
			scaleFontColor: "#666",
			...
			// String - Tooltip label bootstrap.fonts declaration for the scale label
			tooltipFontFamily: "'Helvetica Neue', 'Helvetica', 'Arial', sans-serif",

			// Number - Tooltip label bootstrap.fonts size in pixels
			tooltipFontSize: 14,

			// String - Tooltip bootstrap.fonts weight style
			tooltipFontStyle: "normal",

			// String - Tooltip label bootstrap.fonts colour
			tooltipFontColor: "#fff",

			// String - Tooltip title bootstrap.fonts declaration for the scale label
			tooltipTitleFontFamily: "'Helvetica Neue', 'Helvetica', 'Arial', sans-serif",

			// Number - Tooltip title bootstrap.fonts size in pixels
			tooltipTitleFontSize: 14,

			// String - Tooltip title bootstrap.fonts weight style
			tooltipTitleFontStyle: "bold",

			// String - Tooltip title bootstrap.fonts colour
	...
	Chart.RadialScale = Chart.Element.extend({
		...
		calculateCenterOffset: function(value){
			// Take into account half bootstrap.fonts size + the yPadding of the top value
...
(function(){
	...
	Chart.Type.extend({
		...
		defaults:{
			...
			//String - Point label bootstrap.fonts declaration
			pointLabelFontFamily : "'Arial'",

			//String - Point label bootstrap.fonts weight
			pointLabelFontStyle : "normal",

			//Number - Point label bootstrap.fonts size in pixels
			pointLabelFontSize : 10,

			//String - Point label bootstrap.fonts colour
